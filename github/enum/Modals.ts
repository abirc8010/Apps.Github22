export enum ModalsEnum {
    ...
    SHARE_PULL_REQUEST_ACTION = 'share-pull-request-action',
    TRIGGER_ISSUE_DISPLAY_MODAL = 'display-issue',
    TRIGGER_PULL_REQUEST_DISPLAY_MODAL = 'display-pull-request',
    SWITCH_ISSUE_ORDER = 'switch-issue-order',
    ISSUES_ASCENDING = 'asc',
    PULL_REQUESTS_ASCENDING = 'asc',
    ISSUES_DESCENDING = 'desc',
    PULL_REQUESTS_DESCENDING = 'desc',
    SWITCH_ISSUE_STATE = 'switch-issue-state',
    SWITCH_PULL_REQUEST_STATE = 'switch-pull-request-state',
    SWITCH_ISSUE_SORT = 'switch-issue-sort',
    SWITCH_PULL_REQUEST_SORT = 'switch-pull-request-sort',
    ISSUE_SORT_CREATED = 'sort_created',
    PULL_REQUEST_SORT_CREATED = 'sort_created',
    ISSUE_SORT_UPDATED = 'sort_updated',
    PULL_REQUEST_SORT_UPDATED = 'sort_updated',
    ISSUE_SORT_COMMENTS = 'sort_comments',
    PULL_REQUEST_SORT_COMMENTS = 'sort_comments',
    ...
    CREATED_PULL_REQUEST_FILTER = 'created',
    MENTIONED_ISSUE_FILTER = 'mentioned',
    MENTIONED_PULL_REQUEST_FILTER = 'mentioned',
    SWITCH_ISSUE_FILTER = 'switch-issue-filter',
    SWITCH_PULL_REQUEST_FILTER = 'switch-pull-request-filter',
    USER_ISSUE_VIEW = 'user-issue-view',
    TRIGGER_ISSUES_MODAL = 'trigger-issue-modal',
    TRIGGER_PULL_REQUESTS_MODAL = 'trigger-pull-request-modal',
